...
class _GShapes(Protocol):
    ...
    def cone(
        self, *, radius: float = ..., height: float = ..., segments: int = ..., **_params: Any
    ) -> Geometry:
        """
        円錐を生成します。
    ...
    def sphere(
        self, *, subdivisions: float = ..., sphere_type: float = ..., **_params: Any
    ) -> Geometry:
        """
        半径1の球を生成します。
...
class _PipelineBuilder(Protocol):
    ...
    def affine(
        self, *, pivot: Vec3 | None = ..., angles_rad: Vec3 = ..., scale: Vec3 = ..., **_params: Any
    ) -> _PipelineBuilder:
        """
    ...
    def collapse(
        self, *, intensity: float = ..., subdivisions: float = ..., **_params: Any
    ) -> _PipelineBuilder:
        """
        線分を細分化してノイズで変形（純関数）。
    ...
    def dash(
        self, *, dash_length: float = ..., gap_length: float = ..., **_params: Any
    ) -> _PipelineBuilder:
        """
        連続線を破線に変換（純関数）。
    ...
    def fill(
        self, *, mode: str = ..., angle_rad: float = ..., density: float = ..., **_params: Any
    ) -> _PipelineBuilder:
        """
    ...
    # meta: angles_rad (type=vec3)
    def rotate(
        self, *, pivot: Vec3 = ..., angles_rad: Vec3 = ..., **_params: Any
    ) -> _PipelineBuilder:
        """
        回転（新形式のみ）。
    ...
    def trim(
        self, *, start_param: float = ..., end_param: float = ..., **_params: Any
    ) -> _PipelineBuilder:
        """
    ...
    def weave(
        self,
        *,
        num_candidate_lines: float = ...,
        relaxation_iterations: float = ...,
        step: float = ...,
        **_params: Any,
    ) -> _PipelineBuilder:
        """

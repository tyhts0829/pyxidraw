...
class _GShapes(Protocol):
    ...
    def grid(self, *, nx: int = ..., ny: int = ..., **_params: Any) -> Geometry:
        ...
    def line(self, *, length: float = ..., angle: float = ..., **_params: Any) -> Geometry:
        ...
    def lissajous(self, *, freq_x: float = ..., freq_y: float = ..., freq_z: float = ..., phase: float = ..., phase_y: float = ..., phase_z: float = ..., points: int = ..., **_params: Any) -> Geometry:
        ...
    def polygon(self, *, n_sides: int | float = ..., phase: float = ..., **_params: Any) -> Geometry:
        ...
...
class _PipelineBuilder(Protocol):
    ...
    # meta: amplitude_gradient (type=number, range=[(-4.0, -4.0, -4.0), (4.0, 4.0, 4.0)])
    # meta: frequency_gradient (type=number, range=[(-4.0, -4.0, -4.0), (4.0, 4.0, 4.0)])
    # meta: min_gradient_factor (type=number, range=[0.0, 0.5])
    # meta: max_gradient_factor (type=number, range=[1.0, 4.0])
    # meta: t_sec (type=number, range=[0.0, 10.0])
    def displace(self, *, amplitude_mm: float | tuple[float, float, float] = ..., spatial_freq: float | tuple[float, float, float] = ..., amplitude_gradient: float | tuple[float, float, float] = ..., frequency_gradient: float | tuple[float, float, float] = ..., min_gradient_factor: float = ..., max_gradient_factor: float = ..., t_sec: float = ..., **_params: Any) -> _PipelineBuilder:
        """
        ...
        引数:
            ...
            amplitude_gradient: number, range [(-4.0, -4.0, -4.0), (4.0, 4.0, 4.0)]
            frequency_gradient: number, range [(-4.0, -4.0, -4.0), (4.0, 4.0, 4.0)]
            min_gradient_factor: number, range [0.0, 0.5]
            max_gradient_factor: number, range [1.0, 4.0]

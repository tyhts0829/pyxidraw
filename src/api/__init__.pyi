...
class _PipelineBuilder(Protocol):
    ...
    def displace(self, *, amplitude_mm: float | tuple[float, float, float] = ..., spatial_freq: float | tuple[float, float, float] = ..., amplitude_gradient: float | tuple[float, float, float] = ..., min_gradient_factor: float = ..., max_gradient_factor: float = ..., t_sec: float = ..., **_params: Any) -> _PipelineBuilder:
        """

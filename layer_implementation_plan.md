...
- [ ] Parameter GUI: Style レイヤーを新設し Display/HUD ヘッダを廃止して統合。背景色・グローバル line 色・HUD 色と各レイヤーの色/太さを Style で編集する UI 仕様を詰める。
- [ ] HUD トグル: HUD ヘッダの show_hud ボタンを削除し、キーボードショートカット `H` のトグルで置き換える。
